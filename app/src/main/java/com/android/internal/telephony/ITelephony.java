...
frameworks/base/telephony/java/com/android/internal/telephon

y/ITelephony.aidl
 */
package com.android.internal.telephony;
/**
 * Interface used to interact with the phone.  Mostly this is used by 

the
 * TelephonyManager class.  A few places are still using this directly.
 * Please clean them up if possible and use TelephonyManager 
...
implements com.android.internal.telephony.ITelephony
{
...
return new com.android.internal.telephony.ITelephony.Stub.Proxy
...
/**
     ...
     */
public void dial(java.lang.String number) throws 
...
/**
     ...
     */
public void call(java.lang.String number) throws 
...
on
     ...
     */
public boolean showCallScreen() throws 
...
(Stub.TRANSACTION_showCallScreenWithDialpad, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
/**
     ...
     */
public void answerRingingCall() throws 
...
/**
     ...
     * even if there's no incoming call.  (If so, this method will do 
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_silenceRinger, _data, _reply, 
...
/**
     ...
     */
public boolean isSimPinEnabled() throws 
...
/**
     ...
     */
public void cancelMissedCallsNotification() throws 
...
(Stub.TRANSACTION_cancelMissedCallsNotification, _data, _reply, 
...
determined.
     ...
     */
public boolean supplyPin(java.lang.String pin) throws 
...
/**
     * Handles PIN MMI commands (PIN/PIN2/PUK/PUK2), which 
...
are initiated
     ...
     */
public boolean handlePinMmi(java.lang.String dialString) throws 
...
/**
     ...
     */
public boolean setRadio(boolean turnOn) throws 
...
/**
     ...
     */
public void updateServiceLocation() throws 
...
/**
     ...
     */
public void enableLocationUpdates() throws 
...
/**
     ...
     */
public void disableLocationUpdates() throws 
...
/**
     ...
     */
public int enableApnType(java.lang.String type) throws 
...
/**
     ...
     */
public int disableApnType(java.lang.String type) throws 
...
/**
     ...
     */
public boolean enableDataConnectivity() throws 
...
/**
     ...
     */
public boolean disableDataConnectivity() throws 
...
/**
     ...
     */
public boolean isDataConnectivityPossible() throws 
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isDataConnectivityPossible, 
...
public android.os.Bundle getCellLocation() throws 
...
getNeighboringCellInfo() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<android.telephony.NeighboringCellInfo> _result;
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCallState, _data, _reply, 
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getDataState, _data, _reply, 
...
/**
     ...
     * Returns TelephonyManager.PHONE_TYPE_CDMA if 

RILConstants.CDMA_PHONE
     * and TelephonyManager.PHONE_TYPE_GSM if 

RILConstants.GSM_PHONE
     */
public int getActivePhoneType() throws 
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getActivePhoneType, _data, 
...
/**
     ...
     */
public int getCdmaEriIconIndex() throws 
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCdmaEriIconIndex, 
...
/**
     ...
     * 1 - FLASHING
     */
public int getCdmaEriIconMode() throws 
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCdmaEriIconMode, 
...
/**
     ...
     */
public java.lang.String getCdmaEriText() throws 
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCdmaEriText, _data, 
...
/**
     ...
     */
public boolean getCdmaNeedsProvisioning() throws 
...
(Stub.TRANSACTION_getCdmaNeedsProvisioning, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
/**
      ...
      */
public int getVoiceMessageCount() throws 
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getVoiceMessageCount, 
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getNetworkType, _data, 
...
(android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
...
(android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
...
(android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_disableLocationUpdates = 

(android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_enableApnType = 

(android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_disableApnType = 

(android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_enableDataConnectivity = 

(android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_disableDataConnectivity = 

(android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_isDataConnectivityPossible = 

(android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
...
(android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
...
(android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
...
(android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
...
(android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_getNetworkType = 

(android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
...
/**
     * Toggles the radio on or off.
     */
public void toggleRadioOnOff() throws 
